...
| **Social Studio** add-on | **+$19 / property / month** | `hotelops_social_studio_monthly` | One AI-drafted social post per property per day — captions, hashtags, image pick from the media catalog. Generated by a daily cron; no on-demand regeneration (cost stays flat) |
...
Max ARPU at full add-on attach: **$207 / property / month**.

## Social Studio — +$19 / property / month
...
gpt-4o-mini token rates one generation is ~$0.0006, so $19 covers AI
