        ...
        <Card className="w-full max-w-md">
          <CardBody className="space-y-4 p-8 text-center">
            ...
            <p className="text-sm text-muted leading-relaxed">
              We’ll review your request and be in touch within one business
              day at the email you provided. Once we approve your account,
              you’ll get a setup link to sign in and start using {BRAND.name}.
            </p>
